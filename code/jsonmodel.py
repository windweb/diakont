...
class TreeItem:
    ...
    @classmethod
    def load(
        cls, value: Union[List, Dict, str], parent: "TreeItem" = None, sort=True
    ) -> "TreeItem":
...
class JsonModel(QAbstractItemModel):
    ...
    def load(self, document: Union[dict, list, tuple]):
        ...
        self._rootItem = self.__class__.item_type.load(document)
    ...
    def columnCount(self, parent=QModelIndex()):
        ...
        Return column number. For the model, it always returns number of headers
        """
